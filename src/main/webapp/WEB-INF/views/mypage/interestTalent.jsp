...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="<c:url value="/resources/css/interestTalent.css"/>">
    ...
    <div class="row">
        <div class="col-3">
            ...
            <div id="menuList">
                ...
                <span class="menuText"><a href="pointdeposituser.do?usNo=${user.usNo }">포인트 출금</a></span><br><br>
                <span class="menuText"><a
                        href="withdrawhistory.do?usNo=${user.usNo }&startDate=2021-01-01&endDate=2022-01-01">포인트 출금내역</a></span><br><br>
                <span class="menuText"><a href="closeaccountform.do">회원 탈퇴</a></span><br><br>
            </div>
        </div>
        <div class="col-9">
            <div id="titleName"><h3>찜 내역</h3></div>
            ...
            <div id="tableArea">
                ...
                <div id="selectContent">
                    ...
                    <select name="category" class="selectInput" required>
                ...
                <table id="table" border="1">
                    ...
                    <tr class="table-secondary">
                        <th id="no">No.</th>
                        <th id="projectName">프로젝트 명</th>
                        <th id="seller">판매자</th>
                        <th id="date">판매 등록 일자</th>
                        <th id="cancel">관심상품 취소</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>

        ...
        <div class="row">
            <div class="col-3">
                ...
                <div id="menuList">
                    ...
                    <span class="menuText"><a href="buylist.do?usNo=${user.usNo }&finStatus=1s">재능 구매내역</a></span><br><br>
                    ...
                    <span class="menuText"><a href="#"><b><u>포인트 출금</u></b></a></span><br><br>
            ...
            <div class="col-9">
                ...
                <form action="">
                    <div id="selectAccount" >
                        ...
                        <input id="submitButton"  type="submit" value="정산하기" class="btn btn-sm btn-primary">
                    </div>
                </form>

...
<body>
    ...
    <div class="container" id="boardDetail">
        <div class="row">
            <div class="col-3">
                <div id="sideBarImgArea">
                    ...
                    <div id="message">
                        <button onclick="messagePopup()" class="btn btn-outline-primary btn-lg">판매자에게 문의하기</button>
                    </div>
                </div>
                
                <hr>
                
                <div id="pageName"><b>자기소개</b></div>
        ...
        <div class="col-9">
                ...
                <div class="row">
                    <span class="detail-content"><b>재능 등록 날짜 : &nbsp;</b></span><span class="detail-data">0000년/ 00월 / 00일</span>
                </div>

                <div class="row">
                    <span class="detail-content"><b>재능 종류 : &nbsp;</b></span><span class="detail-data">컴퓨터프로그래밍</span>
                </div>
                       ...
                       <!--거래방법 선택하기-->
                        <form action="#">
                           <select name="buySelect" style="width: 150px;">
                                <option disabled selected>거래방법</option>
                ...
                <div class="row">
                    ...
                    <div class="row" id="button-div2"> 
                        <button onclick="#" class="detail-button2 btn btn-outline-primary btn-sm detail-button4">목록</button>
                        ...
                        <button onclick="#" class="detail-button2 btn btn-outline-primary btn-sm detail-button4">신고승인</button>
                        <button onclick="#" class="detail-button2 btn btn-outline-primary btn-sm detail-button4">신고반려</button>
        ...
        <div class="col-6">
            ...
            <div class="row">
                ...
                <b>댓글입력 : </b><textarea cols="60" rows="10" class="text-area"></textarea>

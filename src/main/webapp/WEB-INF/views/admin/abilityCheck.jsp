...
<title>Insert title here</title>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/css/ablilityCheck.css"/>">
...
<body>
        ...
        <div class="row">
            <div class="col-3">
                ...
                <div id="menuList">
                    ...
                    <span class="menuText"><a href="abilitymain.do"><u><b>재능 기부 승인</b></u></a></span><br><br>
            ...
            <div class="col-9">
                ...
                <div id="divBox">
                    ...
                    <!-- 글 제목 -->
                    <h3><input type="text" value="프로그램 개발 재능등록 신청합니다!" readonly="readonly"></h3><br><br>


                    <!-- 글 내용 -->
                    <textarea readonly="readonly" id="textarea">안녕하세요. ~~ 신청합니다!</textarea>

                    <input type="button" value="거절" id="btn" onclick="refuseForm();" class="btn btn-outline-primary">
                    <input type="submit" value="승인" id="btn" class="btn btn-outline-primary">
                    <input type="button" value="보류" id="btn" class="btn btn-outline-primary">
    ...
    <div id="refuse">
		<form>
            ...
            <textarea rows="10" id="refuseContent"></textarea><br>

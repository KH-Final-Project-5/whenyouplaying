...
<head>
    ...
    <%--    <script src="<c:url value="/resources/js/noticeListAdmin.js"/>"></script>--%>
...
<div class="container">
    <div class="row">
        <div class="col-3">
            ...
            <div id="menuList">
                ...
                <span class="menuText"><a class="menuText"
                                          href="noticeListAdmin.do"><u><b>공지 사항</b></u></a></span><br><br>
        ...
        <div class="col-9">
            ...
            <input type="button" value="공지사항 작성" id="btn" class="btn btn-outline-primary">
        </div>
    </div>
</div>

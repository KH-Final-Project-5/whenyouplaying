...
<title>Insert title here</title>
    ...
    <script src="<c:url value="/resources/js/noticeUpdate.js"/>"></script>
</head>
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-9">
                ...
                <div id="divBox">
                    <input type="text" value="제목을 불러옴" id="title"> <br>
                    
                    <textarea id="content">내용을 불러옴</textarea>
                    ...
                    <input type="submit" value="수정 완료" id="btn" class="btn btn-outline-primary">
                    <input type="button" value="수정 취소" id="btn" class="btn btn-outline-primary">
                </div>
            </div>
        </div>
    </div><br><br>

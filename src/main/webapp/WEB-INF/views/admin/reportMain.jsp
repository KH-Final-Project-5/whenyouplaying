        ...
        <div class="row">
            <div class="col-3">
                ...
                <div id="menuList">
                    ...
                    <span class="menuText"><a href="reportMain.do"><u><b>신고 내역 확인</b></u></a></span><br><br>
            ...
            <div class="col-9">
                ...
                <div id="selectBarReason">
                    <select>
                        <option value="" selected disabled>신고 사유</option>
                        <option value="">광고성</option>
                        <option value="">도박성</option>
                ...
                <div id="selectBarStatus">
                    <select>
                        <option value="" selected disabled>글 상태</option>
                        <option value="">삭제 완료</option>
                        <option value="">삭제 반려</option>
                        <option value="">대기 중</option>
                    </select>
                </div>
                ...
                <div class="tableDiv">
                    <table border="1" align="center" class="table">
                        ...
                        <tr>
                            <td>10</td>
                            <td class="tdTitle">클릭해보세요!!</td>
                            <td onclick="suspend();" class="suspend">홍길동</td>
                            <td>삭제 완료</td>
                            <td>2021.08.19</td>
                            <td class="reportReason">기타</td>
                        </tr>
                    <!-- 임시데이터 나중에 for문으로 처리--> 
                        <tr>
                            <td>9</td>
                            <td class="tdTitle" >클릭해보세요!!</td>
                            <td onclick="suspend();" class="suspend">김길동</td>
                            <td>대기 중</td>
                            <td>2021.08.19</td>
                            <td class="reportReason">도박성</td>
                        </tr>
                         <tr>
                            <td>8</td>
                            <td class="tdTitle">클릭해보세요!!</td>
                        ...
                        <tr>
                            <td>7</td>
                            <td class="tdTitle">클릭해보세요!!</td>
                            <td onclick="suspend();" class="suspend">박길동</td>
                            <td>대기 중</td>
                            <td>2021.08.18</td>
                            <td class="reportReason">음란성</td>
                        </tr>

                        <tr>
                            <td>6</td>
                            <td class="tdTitle">클릭해보세요!!</td>
                            <td onclick="suspend();" class="suspend">이길동</td>
                            <td>대기 중</td>
                            <td>2021.08.17</td>
                            <td class="reportReason">기타</td>
                        </tr>
                        ...
                        <tr>
                            <td>5</td>
                            <td class="tdTitle">클릭해보세요!!</td>
                            <td onclick="suspend();" class="suspend">신길동</td>
                            <td>대기 중</td>
                            <td>2021.08.16</td>
                            <td class="reportReason">해당없음</td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td class="tdTitle">클릭해보세요!!</td>

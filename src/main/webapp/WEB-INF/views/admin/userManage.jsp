...
<body>
        ...
        <div class="row">
            <div class="col-3">
                ...
                <div id="menuList">
                    ...
                    <span class="menuText"><a href="userManage.do"><u><b>회원 목록 확인</b></u></a></span><br><br>
                    ...
                    <table id="table" border="1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>유저</td>
                                <td>Y</td>
                                <td><button class="btn btn-secondary btn-sm">정지</button></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>user2</td>
                                ...
                                <td>관리자</td>
                                <td>N</td>
                                <td><button class="btn btn-secondary btn-sm">해지</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <!-- footer 영역-->
    <div id="footerArea" style="width: 100%; height: 300px; background-color: darkgray; margin-top: 200px;" >임시 footer 영역입니다.</div>

    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="col-4">
                        <figure class="figure">
                            ...
                            <figcaption class="figure-caption"><input type="text" class="buyerText" disabled name="imgName"
                    ...
                    <div class="col-8">
                        ...
                        <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=36484ecb4bc45702e85b48b3ddeabe57"></script>
                        <script>
        ...
        <div class="col-3">
            <div class="tradeDiv">
                ...
                <br>
                <button type="button" id="sellCompBtn">구매 완료</button>
            </div>
        </div>
    </div>

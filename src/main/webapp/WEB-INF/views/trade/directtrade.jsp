						...
						<div class="myContentsDiv">
							...
							<div class="labelDiv">
								<label id="addrLabel">배송지 선택
									...
									id="trade_Addr" name="addr_radio" checked="checked"
									onclick="addr();"> 기본 배송지
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" value="2"
									id="trade_New_Addr" name="addr_radio" onclick="newAddr();">
									신규 배송지
								</label>
								<table id="myInformTable">
									...
									<tr>
										...
										<td><input type="text" class="tradeAddrInput"
											id="tradeNewAddr1" name="usAddress1"
											value="${user.usAddress1 }"> <input type="button"
											value="우편 찾기"></td>
										<td rowspan="2"></td>
									</tr>
									<tr style="height: 0;">

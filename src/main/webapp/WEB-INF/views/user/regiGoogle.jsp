                ...
                <form action="regi.do" method="post" class="validation-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <br>
                            <input type="password" class="form-control" id="usPW" placeholder="" value="${googleInfo.usPw }" required name="usPw" readonly="readonly">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <br>
                            <input type="password" class="form-control" id="usPW2" placeholder="" value="${googleInfo.usPw }" required readonly="readonly">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <br>
                            <input type="text" class="form-control" id="usName" placeholder="" value="${googleInfo.usName }" required
                                   name="usName">

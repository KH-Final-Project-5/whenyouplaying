    ...
    <div class="container">
        <div class="row" id="msgList">
            ...
            <div class="col-8" id="msgContent">
                ...
                <div class="msgContent">
                    ...
                    <p>
                        ...
                        천지는 얼마나 기쁘며 얼마나 아름다우냐? 이것을 얼음 속에서 불러 내는 것이 따뜻한 봄바람이다 인생에 따뜻한 봄바람을 불어 보내는 것은 청춘의 끓는 피다 청춘의 피가
                        뜨거운지라
                        인간의 동산에는 사랑의 풀이 돋고 이상의 꽃이 피고 희망의 놀이 뜨고 열락의 새가 운다사랑의 풀이 없으면 인간은 사막이다 오아이스도 없는 사막이다 보이는 끝까지 찾아다녀도
                        목숨이
            ...
            <div class="msgButton">
                ...
                <button class="btn btn-outline-primary btn-lg" style="margin-left: 50px" onclick="">삭제</button>
            </div>
        </div>

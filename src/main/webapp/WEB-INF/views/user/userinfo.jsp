     ...
     <div class="container">   
         <div class="input-form-backgroud row"> 
             <div class="col-3">
                ...
                <div id="menuList">
                    ...
                    <span class="menuText"><a href="#"><b><u>회원정보</u></b></a></span><br><br>
             ...
             <div class="col-9"> 
                <div id="titleName"><h1>회원정보 수정</h1></div> 
         <form class="validation-form" novalidate>
              ...
              <div class="row">
                ...
                <br>
                <input type="usEmail" class="form-control" id="usEmail" placeholder="you@example.com" required name="usEmail">
                ...
                <div class="mb-3">
                    ...
                    <div class="invalid-feedback"> 휴대전화를 입력해주세요. </div>
                             ...
                             <div class="mb-3"> <label for="prAddress">주소</label>
                                ...
                                <div class="mb-3"> <label for="usinfo">자기소개</label>
                                    <br>
                                     <textarea id="userinfo" name="userinfo"></textarea>
                                                ...
                                                <div class="custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="aggrement" required> 
                                                    ...
                                                    </div> <button class="btn btn-primary btn-lg btn-block" type="submit">회원정보 변경</button> 
